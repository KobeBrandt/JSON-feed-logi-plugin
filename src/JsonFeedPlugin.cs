namespace Loupedeck.JsonFeedPlugin
{
    ...
    using Loupedeck.JsonFeedPlugin.Services;

    // This class contains the plugin-level logic of the Loupedeck plugin.

    public class JsonFeedPlugin : Plugin
    {
        ...
        private static volatile Boolean _isLoaded;
        ...
        _ = Task.Run(() =>
        {
            ...
            {
                if (this._isUnloading || this.WebServer != null)
                {
                    return;
                }
            }
        ...
        private void ReportSettingsPreferenceReady() =>
            this._settingsPreferenceAccount.ReportLogin("JSON Feed", "local-settings", null);
    }
}
